...
<div id="menu_bar">
<div id="menu_text"><font  size="-1"><b>HOME >><?php echo $propertyname['Name'];?> >></font> <?php echo $propertyname1['name'];?></b></div>
</div>-->
...
$sql1= mysql_query($inventoory_qry) or die(mysql_error());
    ...
    <a href="roomnames_18_07_2013.php?page=<?php echo $pre?>&bf_id=<?php echo $bf_id;?>&ppro_id=<?php echo $ppro_id;?>&bfrid=<?php echo $bfrid;?>&avr=<?php echo $avr;?>" style="margin:20px 0px 0px 15px; color:#FFF;"> <div style="margin: 7px 0px 0px 13px;"><b>Previous <?php echo $griddays;?> Days</b></div></a>
    </div>-->
          <?php	
	     } 
	     if($page < $totalpages)
...
<tr height="20"> 
 ...
 <div><?php
    ...
    <a href="roomnames_18_07_2013.php?page=<?php echo $pre?>&bf_id=<?php echo $bf_id;?>&ppro_id=<?php echo $ppro_id;?>&bfrid=<?php echo $bfrid;?>&avr=<?php echo $avr;?>" style="margin:20px 0px 0px 15px; color:#FFF;"> <font color="#FFFFFF" face="Verdana, Geneva, sans-serif" size="1"> <div style="margin: 7px 0px 0px 13px;"><b>Previous <?php echo $griddays;?> Days</b></div></font></a>
...
{?>
 ...
 <font  color="#FFFFFF"><?php  echo $bf_data['newroomrate'];?></font></td>
    <?php }
	else{?>    
