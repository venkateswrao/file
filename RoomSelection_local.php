...
$(function() {
 ...
 $(document).ready(function(){             
							...
							$.ajax({ 
								...
								data: { data1:datepic, data2:ppro_id},
...
<table  id="main_tbody1" width="984" height="70px"   border="1" bordercolor="#fff" cellpadding="0" cellspacing="0">
<tr height="70"> 
 <td width="270"  colspan="2" bgcolor="#21678b">&nbsp; <font color="#FFFFFF" face="Verdana, Geneva, sans-serif" ><b>
 <?php echo $propertyname['Name'];?>
 <br>Room Types</b></font></td>
...
<tr height="20"> 
 ...
 <div><?php
    ...
    <a href="RoomSelection.php?page=<?php echo $pre?>&bf_id=<?php echo $bf_id;?>&ppro_id=<?php echo $ppro_id;?>&avr=<?php echo $avr;?>" style="margin:20px 0px 0px 15px; color:#FFF;"><font color="#FFFFFF" face="Verdana, Geneva, sans-serif" size="1"><b>Previous <?php echo $griddays;?> Days</b></font></a>
				</div></td>
