...
}function getProperty1(str)
{
    ...
    xmlhttp.open("GET","wp_rooms_ajax.php?id="+str,true);
    xmlhttp.send();
    subm();
  }	
  function subm()
...
$sql1=mysql_query("SELECT * FROM wp_rooms WHERE ppro_id='$id' and roomid='$rid'") or die(mysql_error());
?>
...
<tr>
<a href="javascript:void(0);" onClick="newRoom('wp_newroom.php?id=<?php echo $id;?>&rid=<?php echo $rid;?> ')">[ADD NEW ROOM]</a>
</tr>
<tr> 
...
?>
<tr class="onmouse">
<td><font color="#000000" face="segoe ui" size="2"><?php echo $sql2['roomname'];?></font></td>
<td><font color="#000000" face="segoe ui" size="2">
<a href="javascript:void(0);" onclick="editRoom('wp_newroom_edit.php?id=<?php echo $sql2['room_id'] ?>&ppd=<?php echo $id;?> & name=<?php echo $sql2['roomname'];?>')">Edit</a></font></td>
<td><a href="deleteproperty.php?room_id=<?php echo $sql2['room_id'] ?>"><font color="#000000" face="segoe ui" size="2">Delete</a></font></b></td>
<!--<td><a href="javascript:void(0);" onclick="deleteRoom('wp_roomedit.php?id=<?php echo $sql2['room_id'] ?> & name=<?php echo $sql2['roomname'];?>')">Delete</a></font></b></td>-->
</tr>
<?php }
else 
{
...
<a href="roomtypes.php">Go Back</a>
</div></div></div>
