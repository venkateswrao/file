...
<div id="content">
<div  id="new1">
<a href="javascript:void(0);" onClick="newRegion('addRegion.php')">ADD NEW Regions</a>

<h2>here the list of Regions</h2>
...
<?php
$sql=mysql_query("SELECT * FROM wp_citys");
...
while($row1 = mysql_fetch_array( $sql))
{
	...
	?>
		<tr class="act">
		<td><font color="#000000" face="segoe ui" size="2"><?php echo $row1['city_name'];?></font></td>
		<?php 
		if($uid=='1')
		{
		?>
		
		<td><a href="deleteregion.php?city_id=<?php echo $row1['city_id'] ?>">Delete</a></font></td>
		<?php
		}?>
